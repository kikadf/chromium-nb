...
#ifndef SERVICES_DEVICE_HID_HID_CONNECTION_NETBSD_H_
#define SERVICES_DEVICE_HID_HID_CONNECTION_NETBSD_H_
...
#endif  // SERVICES_DEVICE_HID_HID_CONNECTION_NETBSD_H_
